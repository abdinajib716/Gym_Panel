...
export const websiteNav: NavItem[] = [
  {
    ...
    href: "/access-control/landing",
    icon: PanelsTopLeft,
    description: "Edit the public landing page copy, hero image, links, and publication status.",
    status: "Live",
    suggestedWidgets: ["Hero image", "Landing copy", "Contact details"],
  },
  {
    title: "Section Layout",
    href: "/access-control/landing/sections",
    icon: GripVertical,
    description: "Choose which public sections appear and drag them into the right order.",
    status: "Live",
    suggestedWidgets: ["Section visibility", "Drag and drop", "Publish order"],
  },
  {
    title: "Our Team",
    href: "/access-control/landing/team",
    icon: Users,
    description: "Create and publish the team profiles shown on the public website.",
    status: "Live",
    suggestedWidgets: ["Team profiles", "Profile images", "Publish status"],
  },
  {
    title: "Testimonials",
    href: "/access-control/landing/testimonials",
    icon: MessageSquareQuote,
    description: "Manage approved testimonials displayed on the public website.",
    status: "Live",
    suggestedWidgets: ["Testimonials", "Portrait images", "Publish status"],
  },
  {
    title: "Contact Inbox",
    href: "/access-control/landing/inbox",
    icon: Mail,
    description: "Read and manage messages submitted through the public contact form.",
    status: "Live",
    suggestedWidgets: ["New messages", "Status updates", "Contact details"],
  },
]
...
export const sidebarNav: Array<NavItem | NavGroup> = [
  {
    title: "Main",
    icon: Dumbbell,
    children: dashboardNav.slice(0, 1),
  },
  {
...
export function getNavItemByPath(pathname: string) {
  return [...dashboardNav, ...gymManagementNav, ...storeNav, ...websiteNav, ...accessControlNav].find((item) => item.href === pathname)
}
