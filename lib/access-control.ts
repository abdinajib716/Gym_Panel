...
const defaultPermissions = [
  ...
  { name: "landing.view", guardName: "web", groupKey: "landing" },
  { name: "landing.update", guardName: "web", groupKey: "landing" },
  ...
  { name: "member_credentials.view", guardName: "web", groupKey: "member_credentials" },
  { name: "member_credentials.resend_email", guardName: "web", groupKey: "member_credentials" },
  { name: "trainer_credentials.view", guardName: "web", groupKey: "trainer_credentials" },
  { name: "trainer_credentials.resend_email", guardName: "web", groupKey: "trainer_credentials" },
