...
function SidebarProvider({
  ...
  React.useEffect(() => {
    ...
    if (cookieValue === "true") setInternalOpen(true)
    if (cookieValue === "false") setInternalOpen(false)
  }, [])
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={cn(
            "bg-sidebar flex h-full w-full flex-col overflow-hidden border-sidebar-border/70",
            variant === "floating" || variant === "inset"
  ...
  return (
    <main
      className={cn(
        ...
        "md:peer-data-[variant=inset]:m-3 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl",
        className,
      )}
      {...props}
    />
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      className={cn(
        "text-sidebar-foreground/65 px-3 text-[11px] font-medium uppercase tracking-[0.18em] group-data-[collapsible=icon]:hidden",
        className,
      )}
      {...props}
    />
...
function SidebarMenuSkeleton({
  ...
  return (
    <div className={cn("flex h-10 items-center gap-3 rounded-lg px-3", className)} {...props}>
