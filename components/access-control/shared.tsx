...
export function AccessPageHeader({
  ...
  return (
    <div className="flex flex-col gap-3 border-b border-border pb-6 sm:pb-7">
      <Breadcrumb>
...
export function AccessToolbar({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex flex-col gap-3 rounded-lg border bg-card p-3 shadow-sm sm:px-4 md:flex-row md:items-center md:justify-between">
      {children}
    </div>
  )
}
...
export function AccessCard({
  ...
  return (
    <Card className={cn("gap-0 rounded-lg border bg-card py-0 shadow-sm", className)}>
...
export function TableEmpty({
  ...
  return (
    <div className="rounded-md border border-dashed bg-muted/35 px-6 py-10 text-center">
