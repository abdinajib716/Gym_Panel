            ...
            >
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <LocalImageUpload
                      label="Sign-in right-side image"
                      hint="This image fills the right side of the desktop sign-in page."
                      value={field.value ?? ""}
